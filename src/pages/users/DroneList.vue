...
const activeFilter = ref("Tất cả tài sản");
const filters = ["Tất cả tài sản", "FPV", "Điện ảnh", "Doanh nghiệp"];
...
const filteredFleet = computed(() => {
  if (activeFilter.value === "Tất cả tài sản") return fleet.value;
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-6">
              ...
              <button
                class="w-full py-4 bg-corporate-blue text-white font-bold text-[10px] uppercase tracking-[0.3em] rounded hover:bg-primary transition-all shadow-md"
              >
                XEM CHI TIẾT
              </button>
            </div>
